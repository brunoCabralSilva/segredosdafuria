...
export default function Home() {
  ...
  const { simplify } = useContext(contexto);
  ...
  return (
    <main className="bg-black flex flex-col items-center justify-center relative">
      <Simplify />
      <header className={`h-screen w-full flex flex-col items-center justify-center bg-cover relative ${simplify ? 'bg-black' : 'bg-ritual'} bg-top`}>
      ...
      <div ref={ describe } className="grid grid-cols-2 sm:grid-cols-8 w-full h-full px-4 sm:px-8 pb-4 gap-4 sm:gap-6">
        <div
          className={`sm:text-3xl ${simplify ? 'bg-black' : 'bg-06'} mt-4 sm:mt-8 bg-cover col-span-2 sm:col-span-8 sm:row-span-1 text-center text-white flex relative cursor-pointer border-transparent items-end`}>
        ...
        <Link href="/trybes" className="col-span-1 sm:col-span-2 sm:row-span-2">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-01'} bg-cover h-full sm:h-40vh text-white flex relative cursor-pointer border-transparent items-end`}>
            <div className={`absolute w-full h-full bg-black/40`} />
        ...
        <Link href="/auspices" className="col-span-1 sm:col-span-2 sm:row-span-4">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-02'} bg-cover h-20vh sm:h-full text-white flex relative cursor-pointer border-transparent items-end`}>
            <div className={`absolute w-full h-full bg-black/40`} />
        ...
        <Link href="/sessions" className="col-span-2 sm:col-span-4 sm:row-span-2">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-boca01'} bg-cover bg-center h-20vh sm:h-full text-white flex relative cursor-pointer border-transparent items-end`}>
            {/* <div className={`absolute w-full h-full bg-black/40`} /> */}
        ...
        <Link href="/forms" className="col-span-1 sm:col-span-2 sm:row-span-2">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-04'} bg-cover h-20vh sm:h-40vh text-white flex relative cursor-pointer border-transparent items-end`}>
            <div className={`absolute w-full h-full bg-black/40`} />
        ...
        <Link href="/rituals" className="col-span-1 row-span-2 sm:col-span-2 sm:row-span-2">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-06'} bg-cover h-full sm:h-40vh text-white flex relative cursor-pointer border-transparent items-end`}>
            <div className={`absolute w-full h-full bg-black/40`} />
        ...
        <Link href="/gifts" className="col-span-2 sm:row-span-2 sm:col-span-3">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-03'} bg-cover bg-center h-20vh sm:h-40vh text-white flex relative cursor-pointer border-transparent items-end`}>
            <div className={`absolute w-full h-full bg-black/40`} />
        ...
        <Link href="/talismans" className="col-span-1 row-span-3 sm:row-span-2 sm:col-span-3">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-08'} bg-cover bg-center h-60vh sm:h-40vh text-white flex relative cursor-pointer border-transparent items-end`}>
            <div className={`absolute w-full h-full bg-black/40`} />
        ...
        <Link href="/loresheets" className="col-span-1 row-span-1 sm:row-span-2 sm:col-span-2">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-12'} bg-cover h-full sm:h-40vh text-white flex relative cursor-pointer border-transparent items-end`}>
            <div className={`absolute w-full h-full bg-black/40`} />
        ...
        <Link href="/advantagesAndFlaws" className="col-span-1 row-span-1 sm:col-span-4 sm:row-span-4">
          <div
            className={`${simplify ? 'bg-black border-2 border-white' : 'bg-10'} bg-top bg-cover h-full sm:h-40vh text-white flex relative cursor-pointer border-transparent items-end`}>
            <div className={`absolute w-full h-full bg-black/40`} />
