...
export default function Help() {
  ...
  const navigationButtonClassName = (value: string) => {
    const baseClassName = 'inline-flex w-full items-center justify-between border px-3 py-3 text-left font-geist-mono text-[11px] font-extrabold uppercase tracking-[0.12em] transition-colors';
  ...
  return (
    <div className="relative h-screen min-h-0 w-full min-w-0">
      <div className="relative flex h-full min-h-0 w-full min-w-0 flex-col overflow-hidden bg-gradient-to-br from-black via-zinc-950 to-red-950/40 text-white">
        ...
        <div className="relative border-b border-white/10 px-4 py-4 sm:px-6 h-[10vh]">
          <div className="flex flex-col gap-3 text-white sm:flex-row sm:items-start sm:justify-between">
            <div>
              <h2 className="font-kingthings text-lg sm:text-xl">Ajuda</h2>
              <p className="mt-1 font-geist-mono text-[11px] sm:text-xs text-white/75">
                {'Regras r\u00e1pidas da mesa, organizadas por tema para consulta durante a sess\u00e3o.'}
              </p>
            </div>
          </div>
        </div>

        <div className="relative h-[90vh] pl-4 py-4 sm:pl-6">
          <div className="grid h-full min-h-0 gap-4 md:grid-cols-[17rem_minmax(0,1fr)]">
            <div className="flex h-full overflow-y-auto flex-col gap-3">
              <div className="principles-scrollbar hidden min-h-0 flex-1 overflow-y-auto overflow-x-hidden border border-white/10 bg-black/55 p-3 md:flex md:flex-col md:gap-2">
                {helpSections.map((section) => (
                  <button
                    key={section}
                    type="button"
                    className={navigationButtonClassName(section)}
            ...
            <div className="min-h-0 flex-1 h-full overflow-y-auto">
              <div className="principles-scrollbar h-full min-h-0 overflow-y-auto overflow-x-hidden border border-white/10 bg-black/55 p-3 sm:p-5">
                <select
                  className="w-full border border-white/10 bg-black/55 px-4 py-3 text-center font-geist-mono text-[11px] font-semibold uppercase tracking-[0.12em] text-white outline-none md:hidden mb-2 bg-black"
                  value={type}
                ...
                </select>
                {
                  ...
                  <div className="w-full">
                    <div className="grid grid-cols-4 overflow-hidden border border-white/10 bg-black/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                      <div className="col-span-2 border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80 md:col-span-1">Atributos</div>
                      <div className="col-span-2 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80 md:col-span-3">Resumo</div>
                      <div className="col-span-2 border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80 md:col-span-1">
                        Força
                      </div>
                      <div className="col-span-2 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80 md:col-span-3">
                ...
                }
                {
                  ...
                  <div className="w-full">
                    <div className="grid grid-cols-4 overflow-hidden border border-white/10 bg-black/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                      <div className="col-span-2 border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80 md:col-span-1">Habilidade</div>
                      <div className="col-span-2 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80 md:col-span-3">Resumo</div>
                      <div className="col-span-2 border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80 md:col-span-1">
                        Atletismo
                      </div>
                  ...
                  <div className="w-full grid grid-cols-1 md:grid-cols-3 gap-2">
                    {
                      dataForms.filter((form: any) => form.name === 'Crinos').map((form: any, index: number) => (
                        <div
                          key={index}
                          className="w-full flex-col items-center justify-center border border-white p-5"
                        >
                          ...
                          <div>
                            <p className="w-full font-kingthings text-center py-2 text-white">{form.name} - {form.subtitle}</p>
                            <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                ...
                }
                {
                  ...
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Fúria (p. 131)</p>
                    ...
                    <Image
                      ...
                      priority
                    />
                    <p className="w-full pt-5 font-kingthings text-lg text-center md:text-left">Frenesi (p. 139)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Delírio (p. 142)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="font-kingthings">Autocontrole + Determinação de 1 - 5:</div>
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">Medo (pânico, descrença, catatonia em posição fetal e uma tentativa desesperada e provavelmente inútil de se fingir de morto). Esquece o que presenciou.</div>

                      <div className="font-kingthings">Autocontrole + Determinação de 6 - 9:</div>
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">Medo controlado (impulso de autopreservação, mas com reações possivelmente recionais ou protetoras, como disparar uma arma no monstro enquanto corre ou tentativas desesperadas de escapar trancando as portar ou lançando obstáculos pelo caminho para ver se o perseguidor desiste).Geralmente esquece o que presenciou.</div>

                      <div className="font-kingthings">Autocontrole + Determinação igual ou maior que 10:</div>
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">Resignação (aceita a situação com a qual precisa lidar e toma uma decisão a partir daí). Não esquece o que presenciou.</div>
                ...
                }
                {
                  ...
                  <div className="w-full">
                    <div className="pb-5 grid grid-cols-7">
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">Força</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Feitos</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Peso Levantado (kg)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">1</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Amassar uma lata de cerveja</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">20 (árvore de Natal, placa de &quot;PARE&quot;)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">2</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Quebrar uma cadeira de madeira</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">45 (vaso sanitário)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">3</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Botar abaixo uma porta de madeira</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">115 (tampa de bueiro, caixão vazio, geladeira)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">4</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Quebrar uma tábua; arrombar uma porta comum</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">180 (caixão cheio, caçamba de lixo vazia)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">5</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Arrombar uma porta corta-fogo; rasgar uma cerca de arame ou portão fechado por correntes</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">250 (motocicleta)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">6</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Arremessar uma motocicleta; partir algemas</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">360 (poste de luz alto e feito de aço)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">7</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Virar um carro pequeno de pontacabeça; estourar um cadeado</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">410 (cavalo)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">8</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Quebrar um cano de chumbo; atravessar uma parede de tijolos com um soco</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">455 (poste telefônico, piano de cauda)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">9</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Atravessar concreto com um soco; partir correntes; arrancar a porta de um carro</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">545 (tronco de árvore, avião pequeno)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">10</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Quebrar um cano de aço; entortar uma viga de aço laminado</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">680 (lancha)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">11</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Virar um carro médio de ponta-cabeça; atravessar com um soco uma chapa de metal de 2,5 cm de espessura</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">910 (drone Predator)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">12</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Quebrar um poste de luz feito de metal; arremessar uma bola de demolição</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">1,3 tonelada (helicóptero da polícia, carro esportivo)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">13</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Virar um SUV de ponta-cabeça; arremessar um carro esportivo</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">1,8 tonelada (carro da polícia)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">14</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Virar um ônibus de ponta-cabeça; arrombar a porta de um cofre</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">2,25 toneladas (contêiner vazio; utilitário esportivo, caminhonete)</div>
                      <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">15</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">Virar um caminhão de ponta-cabeça; arremessar um SUV</div>
                      <div className="col-span-3 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">2,75 toneladas (Humvee - Veículo Automóvel Multifunção de Alta Mobilidade)</div>
                    </div>
                  </div>
                }
                {
                  ...
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Quem vai primeiro? (p. 125)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full mb-2 text-center md:text-left font-kingthings">Dificuldade (p. 119)</p>
                    <div className="w-full">
                      <div className="pb-5 grid grid-cols-2 md:grid-cols-3">
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80 md:col-span-2">Dificuldade da Ação</div>
                        <div className="col-span-1 border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">Quantidade de Sucessos</div>
                        <div className="border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80 md:col-span-2">
                          Fácil (atingir um alvo parado, convencer um 1 amigo leal a ajudá-lo)
                        </div>
                        <div className="col-span-1 border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">
                          1 sucesso
                        </div>
                        <div className="border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80 md:col-span-2">
                ...
                }
                {
                  ...
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Renome (p. 106 - 107)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Vexame (p. 142)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Litania (p. 46)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                ...
                }
                {
                  ...
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Pilares (p. 108 e 109)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Harano (p. 140)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Hauglosk (p. 140)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                ...
                }
                {
                  ...
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Custo de Experiência (p. 110 - 111)</p>
                    <div className="w-full mt-2">
                      <div className="pb-5 grid grid-cols-2">
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">Característica</div>
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">Pontos de Experiência</div>
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">
                          Aumento em Atributo
                        </div>
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">
                          Novo nível x 5
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Premiação de Experiência</p>
                    <div className="w-full">
                      <div className="pb-5 grid grid-cols-2 mt-2">
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">Situação</div>
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">Premiação de Pontos de Experiência</div>
                        <div className="border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">
                          Participação
                        </div>
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">
                          1
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Modelos de Personagens Secundários (p. 102 e Capítulo 9)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                ...
                }
                {
                  ...
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Ritos (p. 180)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Película</p>
                    <div className="w-full mt-2">
                      <div className="grid grid-cols-3 overflow-hidden border border-white/10 bg-black/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                        <div className="col-span-2 border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">Localização</div>
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">Valor da Película</div>
                        <div className="col-span-2 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">
                          Caern ativo
                        </div>
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">
                          2
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl mt-5">Hierarquia Espiritual (p. 232 - 237)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                ...
                }
                {
                  ...
                  <div className="w-full">
                    <div className="w-full">
                      <div className="grid grid-cols-3 overflow-hidden border border-white/10 bg-black/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)]">
                        <div className="col-span-2 border border-red-950 bg-red-950 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white">Arma</div>
                        <div className="border border-red-950 bg-red-950 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white">Valor de Dano</div>
                        <div className="col-span-2 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">
                          Arma improvisada
                        </div>
                        <div className="border border-white/10 bg-black/30 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white/80">
                        ...
                        <div className="col-span-2 border border-red-950 bg-red-950 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white">
                          Tipo de Armadura
                        </div>
                        <div className="border border-red-950 bg-red-950 px-3 py-3 text-center font-geist-mono text-[11px] uppercase tracking-[0.12em] text-white">
                          Valor da Armadura
                        </div>
                        <div className="col-span-2 border border-white/10 bg-black/15 px-3 py-3 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full font-geist-mono text-[11px] tracking-[0.12em] text-white/80 mt-3">Font: p. 195 - 196</p>
                  </div>
                }
                {
                  type === 'Conflitos' &&
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Conflitos (p. 122 à 125)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Esquiva</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Agarramento</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Múltiplos oponentes</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Pegar Metade</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Vitórias Automáticas</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Críticos</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Margem</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Falha Total</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Trabalho em Equipe</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Vencer a um Custo</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Tente outra vez</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                ...
                }
                {
                  type === 'Dano' &&
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Dano (p. 127)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                ...
                }
                {
                  ...
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Força de Vontade (p. 88 e 122)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Regeneração de Força de Vontade (p. 125, 129 e 134)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                ...
                }
                {
                  ...
                  <div className="w-full px-1 py-2 sm:px-2">
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Regeneração de Vitalidade (p. 125, 129 e 134)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
                    ...
                    <p className="w-full text-center font-kingthings text-lg md:text-left sm:text-xl">Debilitação (p. 128)</p>
                    <div className="mb-3 mt-2 h-px w-full bg-white/10" />
                    <div className="w-full">
                      <div className="pb-5 text-justify font-geist-mono text-[11px] leading-6 text-white/80">
                        <ul className="pl-5 font-geist-mono text-[11px] leading-6 text-white/80">
