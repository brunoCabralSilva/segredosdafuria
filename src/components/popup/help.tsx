...
export default function Help() {
  ...
  return (
    <div className="z-80 fixed top-0 left-0 w-full h-screen flex flex-col items-center justify-start bg-black/80 px-3 sm:px-0 border-white border-2">
      ...
      <div className="w-full h-full flex flex-col justify-start items-center bg-black relative pb-5">
        <div className="px-2 md:px-5 w-full overflow-y-auto text-white md:grid md:grid-cols-11 gap-3 mt-5 mb-10">
          <select
          ...
          <div className="col-span-9 border border-white w-full h-full overflow-y-auto p-1 md:p-5">
            {
