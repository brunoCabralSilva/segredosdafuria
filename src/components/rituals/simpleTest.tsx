...
export function SimpleTest() {
  const { sessionId, email, showRitualRoll, setShowRitualRoll, returnSheetValues, setShowMenuSession, } = useContext(contexto);

  const roll = async () => {
    await registerMessage(sessionId, { ...showRitualRoll.ritual, type: 'ritual', }, email);
    returnSheetValues();
  }
