...
export default function Relationships() {
  ...
  function renderGalleryContent() {
    if (!hasGalleryImages || !currentGalleryImageName) {
      return (
        <div className="rounded border border-dashed border-zinc-700 px-4 py-6 text-center text-sm text-zinc-400">
    ...
    return (
      <>
        <button
          ...
          className="relative mb-3 block aspect-video w-full overflow-hidden rounded border border-zinc-700"
        >
          {/* <Image
  ...
  return (
    <div className="z-80 sm:z-50 fixed md:relative w-screen h-screen flex flex-col items-center justify-center border-white border-2 bg-14 bg-center bg-cover">
      <div className="w-full h-screen flex flex-col items-center justify-center px-3 sm:px-0 bg-black/60 bg-center bg-cover">
        <div className="w-full flex items-center justify-between gap-3 pt-1 pb-2 px-2">
        ...
        <div
          onWheel={handleWheel}
          className="w-full h-full bg-cover overflow-auto relative"
        >
