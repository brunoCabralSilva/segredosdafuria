    ...
    <div className="w-full">
      ...
      }
      {
        ...
        <label htmlFor="dificulty" className="mb-4 flex flex-col items-center w-full">
          <p className="text-white w-full pb-3">Dificuldade do Teste (A dificuldade é 3 para outros alvos ou 1 para si mesmo. Alvos relutantes podem resistir com Autocontrole + Determinação)</p>
          <div className="flex w-full">
            <div
