      ...
      if (dataSheet.data.willpower.length === 0) {
        ...
        if (missingInBoth.length > 0) {
          ...
          if (missingInAgravated.length > 0) {
            ...
            setShowMessage({ show: true, text: 'Você não possui mais pontos de Força de Vontade para realizar este teste (Já sofreu todos os danos Agravados possí­veis).' });
            canRoll = false;
          }
        }
      }
  ...
  return(
    <div className="w-full">
      <label
        ...
        />
        <span>Marque se você não for comer o órgão sensorial do cadáver (fazer esta ação é tabu entre muitos Garou)</span>
      </label>
      {
        marked &&
      ...
      }
      {
        ...
        <label htmlFor="dificulty" className="mb-4 flex flex-col items-center w-full">
          <p className="w-full pb-1.5 font-geist-mono text-[10px] uppercase tracking-[0.08em] text-white/78">Dificuldade da Checagem (A dificuldade deve ser igual a 2. Aumente a Dificuldade em 1 para cada 24 horas desde a morte do cadáver, até um máximo de 7)</p>
          <div className="flex w-full">
            <div
