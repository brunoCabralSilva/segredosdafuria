    ...
    <div className="w-full">
      ...
      }
      {
        ...
        <label htmlFor="dificulty" className="mb-4 flex flex-col items-center w-full">
          <p className="w-full pb-1.5 font-geist-mono text-[10px] uppercase tracking-[0.08em] text-white/78">Dificuldade do Teste (A dificuldade deve ser igual a 2. Aumente a Dificuldade em 1 para cada 24 horas desde a morte do cadáver, até um máximo de 7)</p>
          <div className="flex w-full">
            <div
